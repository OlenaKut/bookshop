    ...
    <Col xl={10} md={9} sm={12} className="mt-4">
      ...
      {showContactForm && <ContactForm />}
          <p>
            ...
            <span>
              <Button variant="link" className="contact-page-button fs-5" onClick={handleClick}>
                Contact Us
              </Button>
            </span>{" "}
            form.
          </p>
           <p className="mb-1">For partnerships, promotional opportunities, and advertising inquiries, please email us at:</p>
        <Button
          variant="link"
        ...
        >
         ...
         <p>Interested in joining our team? Email us at<Button
          variant="link"
          href="mailto:promotions@bookshop.org"
          rel="noopener noreferrer"
