const novels = [
  {
    ...
    details: {
      ...
      pages: "496",
      dimensions: "5.2 X 7.8 X 1.4 inches | 0.9 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$15.80",
...

  {
    ...
    details: {
      ...
      publishDate: "July 02, 2013",
      pages: "359",
      dimensions: "5.6 X 8.3 X 1.1 inches | 0.75 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$18.99",
    ...
    authorReviews1: "--Mindy Kaling, Emmy-nominated writer",
    reviews2:
      "This companion novel to Spoiled is a treat.... there are enough witty observations and laugh-out-loud lines to make this about as much fun as you can have reading a book... an engaging, well-plotted story.",
    authorReviews2: "--VOYA",
    reviews3:
...

  {
    ...
    description:
      "Fallon is Type A, looks before she leaps, and always has a plan (and a backup plan). Chloe is happy-go-lucky, flies by the seat of her pants, and always follows her bliss. The two girls used to be best friends, but last summer they hooked up right before Chloe left for college, and after a series of misunderstandings, they aren't even speaking to each other.",
    details: {
      publisher: "G.P. Putnam's Sons Books for Young Readers",
      publishDate: "May 17, 2022",
      pages: "320",
      dimensions: "5.81 X 8.59 X 1.12 inches | 0.95 pounds",
      language: "English",
      type: "Hardcover",
    },
    pris: "$16.73",
...

  {
    ...
    details: {
      ...
      pages: "304",
      dimensions: "5.4 X 8.2 X 0.9 inches | 0.55 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$14.88",
...

  {
    ...
    details: {
      ...
      pages: "496",
      dimensions: "5.25 X 8.0 X 0.9 inches | 0.7 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: " $14.87",
