const historicalFiction = [
  {
    ...
    details: {
      ...
      publishDate: "October 04, 2016",
      pages: "",
      dimensions: "5.4 X 1.2 X 8.3 inches | 1.35 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$17.99",
    ...
    reviews1:
      'Praise for "The Secret Chord" "The Secret Chord "athundering, gritty, emotionally devastating reconsideration of the story of King David makes a masterly case for the generative power of retelling. . .some of the magic here has to do with setting and time for sensory dramatics, it s hard to compete with the Iron Age Middle East. . .but Brooks s real accomplishment is that she also enables readers to feel the spirit of the place.',
    ...
    authorReviews2: "- The Washington Post",
    reviews3:
    ...
    authorReviews3: "- The San Francisco Chronicle",
  },

  {
    ...
    details: {
      publisher: "Dutton",
      publishDate: "July 11, 2017",
      pages: "368",
      dimensions: "5.3 X 7.9 X 0.8 inches | 0.5 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$15.81",
...

  {
    ...
    details: {
      ...
      pages: "576",
      dimensions: "5.2 X 8.2 X 1.5 inches | 1.15 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$16.73",
    ...
    authorReviews2: "- Real Simple magazine",
    reviews3:
...

  {
    ...
    details: {
      ...
      pages: "432",
      dimensions: "6.4 X 9.3 X 1.6 inches | 1.5 pounds",
      language: "English",
      type: "Hardcover",
    },
    pris: "$26.04",
    ...
    authorReviews1: "- Glennon Doyle, author of Untamed",
    reviews2:
    ...
    authorReviews2: "- O, The Oprah Magazine",
    reviews3:
    ...
    authorReviews3: "- The Boston Globe",
  },

  {
    ...
    descriptionShort:
      "AN INSTANT NEW YORK TIMES BESTSELLER! From the # 1 New York Times bestselling author of Eat Pray Love and The Signature of All Things, a delicious novel of glamour, sex, and adventure, about a young woman discovering that you don't have to be a good girl to be a good person.",
    description:
    ...
    details: {
      ...
      pages: "496",
      dimensions: "5.4 X 8.3 X 1.3 inches | 0.95 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$15.81",
    ...
    reviews1:
      "A novel as vibrant, sexy and wise as the author's megahit Eat Pray Love.",
    authorReviews1: "- People Magazine",
    reviews2:
      "The girls and women of the book don't simply endure: they thrive, they dance, they live. Grab some champagne and toast...",
    authorReviews2: "- OprahMag.com",
    reviews3:
    ...
    authorReviews3: "- EntertainmentWeekly.com",
  },

  {
    ...
    details: {
      ...
      publishDate: "March 09, 2021",
      pages: "656",
      dimensions: "5.3 X 8.0 X 1.05 inches | 1.04 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: " $16.73",
