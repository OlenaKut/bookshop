const bestcellers = [
  //bestcellers
  {
    ...
    details: {
      ...
      pages: "April 11, 2023",
      dimensions: "6.37 X 9.27 X 1.24 inches | 1.03 pounds",
      language: "English",
      type: "Hardcover",
    },
    pris: "$26",
    ...
    authorReviews1: "--Booklist (starred review)",
    reviews2:
...

  {
    ...
    details: {
      ...
      pages: "382",
      dimensions: "5.5 X 8.5 X 0.85 inches | 1.07 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$19",
    ...
    aboutTheAuthor:
      "Chelsea Fagan is an author and the founder of The Financial Diet, the largest women's personal finance media company. She lives in Manhattan with her husband and dog.",
    reviews1: "",
    authorReviews1: "",
    reviews2: "",
    authorReviews2: "",
...

  {
    ...
    authorReviews1: "--Lynn Steger Strong, author of FLIGHT",
    reviews2:
    ...
    authorReviews2: "--Isle McElroy, author of THE ATMOSPHERIANS",
    reviews3:
    ...
    authorReviews3: "--A.E. Osworth, author of WE ARE WATCHING ELIZA BRIGHT",
  },

  {
    ...
    details: {
      ...
      pages: "400",
      dimensions: "6.3 X 9.29 X 1.65 inches | 1.35 pounds",
      language: "English",
      type: "Hardcover",
    },
    pris: "$26",
    ...
    authorReviews1: "--Oprah Quarterly",
    reviews2:
...

  {
    ...
    details: {
      ...
      pages: "256",
      dimensions: "5.4 X 8.4 X 0.9 inches | 0.56 pounds",
      language: "English",
      type: "Paperback",
    },
    pris: "$18",
    ...
    reviews1: "It's one of the best and most original finance books in years.",
    authorReviews1: "-- Jason Zweig, The Wall Street Journal",
    reviews2:
    ...
    authorReviews2: "-- Annie Duke, Author, Thinking in Bets",
    reviews3:
